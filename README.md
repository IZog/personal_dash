...
1. Open `index.html` in a modern browser (Chrome, Edge, Safari or Firefox). No build step is required.
2. The interface is responsive. On mobile, add it to your home screen for an app-like feel.
